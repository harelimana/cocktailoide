...
// Returns the private 'App\Repository\CocktailRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CocktailRepository.php';

return $this->privates['App\Repository\CocktailRepository'] = new \App\Repository\CocktailRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
