...
}, 'App\\Repository\\CocktailRepository' => function () {
    return ($this->privates['App\Repository\CocktailRepository'] ?? $this->load('getCocktailRepositoryService.php'));
}, 'App\\Repository\\IngredientRepository' => function () {
    return ($this->privates['App\Repository\IngredientRepository'] ?? $this->load('getIngredientRepositoryService.php'));
}))));
