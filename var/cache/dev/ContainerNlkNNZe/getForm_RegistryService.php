...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CategorieType' => function () {
...
}, 'App\\Form\\CocktailType' => function () {
    return ($this->privates['App\Form\CocktailType'] ?? $this->privates['App\Form\CocktailType'] = new \App\Form\CocktailType());
    ...
    yield 1 => ($this->privates['form.type_extension.form.data_collector'] ?? $this->load('getForm_TypeExtension_Form_DataCollectorService.php'));
...
}, 1))), ($this->privates['form.resolved_type_factory'] ?? $this->load('getForm_ResolvedTypeFactoryService.php')));
